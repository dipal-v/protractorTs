...
const E2E_PORT = process.env.WEBPACK_PORT || "8080";
...
module.exports = {
  scripts: {
    ...
    webpack: {
      ...
      server: {
        default: `webpack-dev-server --host 0.0.0.0 -d --inline --env.server --disable-host-check --port=${E2E_PORT}`,
