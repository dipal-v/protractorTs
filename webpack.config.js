...
// primary config:
const title = 'Weclome to Leto again';
const outDir = path.resolve(__dirname, 'dist');
const srcDir = path.resolve(__dirname, 'src');
const nodeModulesDir = path.resolve(__dirname, 'node_modules');
// this is hard coded url prefix
// update this when your app is not hosted under root
const publicPath = '/'
...
module.exports = ({production, server, extractCss, coverage} = {}) => ({
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([
      ...
      { from: 'assets/locales/en/translation.json', to: 'locales/en/translation.json' },
      { from: 'config.json', to: 'config/config.json' }
    ]),
